...
# optimizer
opt_mm = GPyOpt.methods.BayesianOptimization(f=f, domain=bounds, maximize=True)

# #### Running optimization

# optimize MM model
opt_mm.run_optimization(max_iter=50)
...
print("optimized accuracy: {0}".format(abs(opt_mm.fx_opt)))
